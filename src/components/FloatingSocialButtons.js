    ...
    <div className="fixed right-4 bottom-20 z-50 flex flex-col items-end space-y-3">
      ...
      <div className="flex flex-col space-y-3 animate-slideUp">
        ...
        <a
          ...
          className="group relative bg-green-500 hover:bg-green-600 text-white p-3 rounded-full shadow-lg transform hover:scale-110 transition-all duration-300 animate-bounceIn"
