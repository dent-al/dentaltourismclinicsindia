...
const OffersStrip = () => {
  ...
  const downloadButtonStyle = {
    background: 'linear-gradient(135deg, #FFD700 0%, #F4A300 50%, #FF8C00 100%)',
    color: '#2C73D2',
    fontWeight: 'bold',
    padding: '0.5rem 1rem',
    borderRadius: '25px',
      ...
      <div style={{ display: 'flex', alignItems: 'center', flex: 1 }}>
        ...
        >
          <span style={{
            ...
            <span style={{color: '#F4A300'}}>★</span> Smile Dental Care: <span style={{color: 'white'}}>10% off on first visit</span>
          </span>
          <span style={{
            marginRight: '2.5rem', 
            display: 'inline-block', 
            ...
            <span style={{color: '#F4A300'}}>★</span> Pearl Dental Studio: <span style={{color: 'white'}}>Free consultation for new patients</span>
          </span>
          <span style={{
            marginRight: '2.5rem', 
            display: 'inline-block', 
            ...
            <span style={{color: '#F4A300'}}>★</span> Bright Smiles Clinic: <span style={{color: 'white'}}>Complimentary dental checkup</span>
          </span>
        </marquee>
      </div>
      ...
      <div style={{ paddingRight: '1.5rem', flexShrink: 0 }}>
        <Link 
          ...
          onMouseOver={(e) => {
            ...
            e.target.style.boxShadow = '0 6px 20px rgba(44, 115, 210, 0.5)';
