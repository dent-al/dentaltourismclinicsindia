...
const BloodTestLabList = () => {
  ...
  return (
    <div className="p-8 bg-[#ede7f6] min-h-screen">
      <h2 className="text-2xl font-bold mb-4 text-[#6548ee]">Blood Test Labs</h2>
